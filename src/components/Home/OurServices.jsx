      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
          {healthcareServices.map((service) => (
            ...
            >
              <h4 className="text-center first-letter:font-bold first-letter:text-2xl first-letter:text-[#cd2028] w-full  text-black font-poppins text-xl">
                <span>{service.fullForm}</span>
              </h4>
              <p className="text-md font-poppins">{service.description}</p>
            </Link>
          ))}
        </div>
      </Container>
