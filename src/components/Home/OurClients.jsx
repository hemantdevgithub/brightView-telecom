        ...
        <div className='py-10'>
            <Container>
                <div className='space-y-5'>
                    <h1 className='text-center text-3xl font-semibold tracking-wider font-syne text-blue-500'>Our Honorable Clients</h1>
                    <Swiper
                        slidesPerView={1}
                        spaceBetween={30}
                        autoplay={{ delay: 2000 }}
    ...
    return (
        <div className="bg-gray-100 px-10 py-5 rounded-md">
            <div className='flex flex-col justify-center lg:px-10 py-5 gap-5'>
                ...
                <p className='text-sm lg:text-[15px] font-syne'>
                    {
                        testimonial
                    }
                </p>
                <div className="flex gap-10">
                    <div>
                        <h3 className="text-xl font-semibold font-alegreya">
                            {name}
                        </h3>
