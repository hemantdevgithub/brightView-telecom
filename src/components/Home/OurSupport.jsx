...
const OurSupport = () => {
  return (
    <div className="bg-[#f5f5f8] py-10 font-poppins">
      <Container>
        <div className="flex flex-col lg:flex-row gap-10 w-[80%] mx-auto">
          ...
          <div className="w-full lg:w-[50%] flex flex-col justify-center gap-10">
            <h3 className="text-xl lg:text-3xl font-poppins font-semibold text-primary flex gap-2">
              Get
              <span className="text-[#1b2651] font-semibold">
                Health
                <span className="text-[#cd2028] font-semibold">FROGS</span>
              </span>
              Support
            </h3>
