        ...
        <div className="h-[400px] hero font-syne bg-[url(/Home/hero.jpg)] bg-center bg-cover w-full">
            <Container>
                <div className="w-full lg:w-[65%] h-full gap-6 flex sm:text-center md:text-start flex-col items-center lg:items-start justify-center">
                    <div className="bg-white/30 backdrop-blur-lg border border-white/20 shadow-lg p-6 rounded-lg">
                        ...
                        <h1 className="text-sm lg:text-xl font-semibold ">
                            HealthFROGS finds the right solution partner for the
                            healthcare customers and right customers for the
                            healthcare solution partners
                        </h1>
