...
import { FaEnvelope, FaLinkedin, FaMapPin } from "react-icons/fa6";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold">
                <span>Brightview</span> <span>Telecom</span>
              </h2>
              <h4 className="text-white font-semibold">Contact Info</h4>
              <Link to={""} className="flex items-start">
                <IoIosPin size={38} className="-mt-1" />
              ...
              <Link to={""} className="flex items-center gap-2">
                <FaEnvelope size={14} className="mt-[1px]" />{" "}
            ...
            <div className="space-y-4">
              <h4 className="text-white font-semibold">Opening Time</h4>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Link
                  ...
                  className="flex items-center hover:underline"
                >
                  <i className="fas fa-angle-right mr-2" /> Services
                </Link>
                <Link
                  href="/awards"
                  className="flex items-center hover:underline"
                ...
                <Link
                  ...
                  className="flex items-center hover:underline"
                >
                  <i className="fas fa-angle-right mr-2" /> Clients
                </Link>
                <Link
                  href="/contact"
                  className="flex items-center hover:underline"
                >
                  <i className="fas fa-angle-right mr-2" /> Contact Us
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <Link
                to={
                  "https://www.linkedin.com/company/brightview-telecom-private-limited/?originalSubdomain=in"
                }
                target="_blank"
                className="flex items-center hover:underline"
              >
