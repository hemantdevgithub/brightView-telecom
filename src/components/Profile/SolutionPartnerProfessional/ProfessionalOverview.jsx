...
import {
  deleteProfessionalProfileEducation,
  deleteProfessionalProfileWorkExperience,
  updateProfessionalProfile,
} from "../../../Api/solutionPartnerProfessionalApi";
...
const ProfessionalOverview = ({ profile, user, isLoading }) => {
  ...
  const handleFormSubmit = async (data) => {
    try {
      const response = await updateProfessionalProfile({ data });
  ...
  const handleDeleteWorkExperience = async (workExperienceId) => {
    ...
    try {
      const response =
        await deleteProfessionalProfileWorkExperience(workExperienceId);
  ...
  return (
    <div className="w-full px-10 py-5 rounded-md overflow-y-scroll h-full remove_scrollbar space-y-5">
      <div className="flex flex-col gap-3 lg:flex-row items-center justify-between">
        <h2 className="text-lg lg:text-xl text-softBlue">
          ...
          <div className="grid grid-cols-2 gap-5">
            {profile?.workExperiences.length !== 0 ? (
              profile?.workExperiences?.map((item, index) => (
                ...
                >
                  <h4 className="font-poppins text-softBlue font-semibold text-[17px]">
                    {item.position}
                  </h4>
            ...
            <div className="space-y-5 border p-5 rounded-md">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-3">
                  ...
                  <button className=" bg-softBlue rounded-md text-white text-sm px-5 py-1">
                    Save
                  </button>
                </div>
              </div>
