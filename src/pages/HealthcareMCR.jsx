    ...
    <div>
      ...
      <Container>
        <div className="py-10 space-y-10">
          {/* <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center gap-5'>
                        {
                            organizations.map(p => (
                                <div className='h-[250px] border rounded-md relative overflow-hidden'>
                                    ...
                                    <div
                                        className='absolute text-center flex items-center text-white text-lg z-10 justify-center h-full font-poppins w-full'>
                                        <p> {p.title}</p>
                                    </div>
                                </div>
                            ))
          ...
          <h1 className="text-center flex flex-col lg:flex-row justify-center items-center gap-3 text-2xl font-poppins text-blue-800 font-semibold">
