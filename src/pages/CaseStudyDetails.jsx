...
const CaseStudyDetails = () => {
  ...
  return (
    <div className="bg-[#f5f5f5] font-poppins py-10">
      <Container>
              ...
              <div className="w-full border border-blue-400 rounded-b-md">
                ...
                <div className="space-y-5 p-3">
                  <div className="flex items-center justify-between">
                    <p className="uppercase text-xs text-orange-400 font-poppins font-semibold">
                      {filteredStudy.category}
                    </p>
                    <p className="text-xs">{filteredStudy.date}</p>
                  </div>
                  <h4 className="text-xl">{filteredStudy.title}</h4>
                  <div className="w-full h-[1px] bg-primary"></div>
                  <p className="text-secondary">{filteredStudy.content}</p>
                </div>
              </div>
            )}
          </div>
