...
const Login = () => {
  ...
  return (
    <div className={`w-full bg-gray-100 flex font-poppins`}>
      <div className="min-h-full text-white hidden lg:w-[40%] bg-softBlue lg:flex justify-center text-center items-center">
        <div className="space-y-8 w-[80%] mx-auto">
          ...
          <p className="text-2xl">Don't Have account Yet ?</p>
          <p>
        ...
        >
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              />
              <p className="text-secondary">Remember Me</p>
            </div>
            <p className="text-softBlue text-sm hover:underline cursor-pointer">
              Forgot Password ?
            </p>
          </div>
          <input
            type="submit"
            value="Log in"
            className={`w-full cursor-pointer bg-softBlue py-2 text-white uppercase font-poppins rounded-md`}
          />
        </form>
