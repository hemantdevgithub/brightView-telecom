...
const CaseStudies = () => {
  return (
    <div>
      <TopBanner heading={"HealthCare Insights"} img="About\Insights.png" />
      <Container>
        <div className="py-10 space-y-10">
          <h2 className="text-3xl text-secondary font-poppins">
            HealthCare Insights :
          </h2>
            ...
            {caseStudies
              ...
              .map((caseStudy) => (
                ...
                >
                  ...
                  <p className="uppercase font-poppins font-semibold text-orange-400 text-sm">
                    {caseStudy.name}
                  </p>
